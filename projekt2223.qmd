---
title: "Analiza liczby ludności świata w latach"
lang: pl
author: "Kacper Drążek"
date: 2023-01-19
format: 
  html:
    warning: false
...
Tematem projektu jest analiza zmian liczby ludności na świecie w latach 2006 - 2022 na podstawie tabeli z [Wikipedii](https://pl.wikipedia.org/wiki/Lista_pa%C5%84stw_%C5%9Bwiata_wed%C5%82ug_liczby_ludno%C5%9Bci). W projekcie różne warianty tabeli zostały przedstawione na wykresach oraz podtabelach. Analizowana tabela przedstawia państwa świata i terytoria zależne, uszeregowane według liczby ludności. Tabelę opracowano na podstawie danych amerykańskiej Centralnej Agencji Wywiadowczej (pochodzą one z lipca danego roku). Należy zauważyć, że dane te niejednokrotnie odbiegają od danych podawanych przez Organizację Narodów Zjednoczonych oraz wyników spisów powszechnych.

```{r}

#bibliography: references.bib
rm(list = ls()) 
#pozyskanie tabeli i jej przygotowanie do analizy
#Xpath metoda
...
Przedstawiam 20 pierwszych wierszy tabeli:
...
Poniższe wykresy przedstawiają cztery kraje z największym udziałem w ludności świata w przykładowych latach:
...
Te same dane zaprezentowane za pomocą wykresu kołowego:
...
Na przedstawionych wykresach widać, że nie zmieniły się cztery najludniejsze państwa świata oraz zachowana została kolejność między nimi. Liczba ludności Chin oraz Indii wraz z upływem lat zbliżała się do siebie aż do zrównania.

Inne typy wykresów kołowych z lat 2016 i 2018:
...
Na powyższym wykresie widać, że liczba ludności świata urosła w analizowanym okresie liniowo.
...
Powyższy wykres pokazuje jaka była różnica w liczbie ludnosci w poszczególnych latach. W ciągu ostatnich 5 lat widoczny jest gwałtowny wzrost różnicy. W ostatnich 5 latach różnica między liczbą ludności UE i ChRL gwałtownie wzrasta, czyli liczba ludności UE spada, a ChRL przybywa.
...
Jak widać na powyższych wykresach krajami w 2022 roku, które przekroczyły liczbę ludność powyżej miliarda to tylko Indie oraz Chiny. Państwa, które odstają od średniej liczby ludności to np. USA, Brazylia, Nigeria, Pakistan, Indonezja.
...
Jak widać średnia liczba ludności w krajach wzrosła z 57 milionów w 2006 roku do 68 milionów w 2022. Rośnie również odchylenie standardowe.
...
W powyższej tabelce przedstawione są kraje z największym spadkiem ludności między 2018 a 2022 rokiem. Znalazła się również wśród nich Polska. Należy zaznaczyć, że w tym okresie na świecie rozwinęła się pandemia COVID-19.
